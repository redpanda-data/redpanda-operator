...
require (
	...
	github.com/redpanda-data/redpanda-operator/operator v0.0.0-20251120164856-73a55da0a551
...
require (
	...
	github.com/redpanda-data/redpanda-operator/charts/redpanda/v5 v5.10.5 // indirect
