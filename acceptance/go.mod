...
require (
	...
	buf.build/gen/go/redpandadata/core/connectrpc/go v1.20.0-20260706172830-ee867ae38d23.1 // indirect
	...
	github.com/redpanda-data/common-go/portmapper v0.0.0-20260914143223-4f2e6f1536dd // indirect
