...
require (
	...
	github.com/redpanda-data/redpanda-operator/operator v0.0.0-20251125071431-634f74e9db59
...
require (
	...
	github.com/redpanda-data/redpanda-operator/charts/redpanda/v5 v5.9.29 // indirect
