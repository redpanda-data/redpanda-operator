...
func init() {
	...
	framework.RegisterStep(`^the internal service of cluster "([^"]*)" should have no selector$`, serviceOfClusterShouldHaveNoSelector)
	framework.RegisterStep(`^every unsteered service of cluster "([^"]*)" should have a selector$`, unsteeredServicesOfClusterShouldHaveSelectors)
	framework.RegisterStep(`^the "([^"]*)" listener of cluster "([^"]*)" should publish pods "([^"]*)"$`, clusterListenerShouldPublishPods)
	...
	framework.RegisterStep(`^pod "([^"]*)" should be ready$`, podIsReady)
	...
	framework.RegisterStep(`^I set annotation "([^"]*)" to "([^"]*)" on V1 cluster "([^"]*)"$`, setAnnotationOnVectorizedV1Alpha1Cluster)
	framework.RegisterStep(`^I remove annotation "([^"]*)" from V1 cluster "([^"]*)"$`, removeAnnotationFromVectorizedV1Alpha1Cluster)
	framework.RegisterStep(`^I set annotation "([^"]*)" to "([^"]*)" on Redpanda "([^"]*)"$`, setAnnotationOnRedpandaV1Alpha2Redpanda)
	framework.RegisterStep(`^I remove annotation "([^"]*)" from Redpanda "([^"]*)"$`, removeAnnotationFromRedpandaV1Alpha2Redpanda)
