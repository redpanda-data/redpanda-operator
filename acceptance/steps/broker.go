...
func setAnnotationOnVectorizedV1Alpha1Cluster(ctx context.Context, t framework.TestingT, annotationKey, annotationValue, clusterName string) {
	key := t.ResourceKey(clusterName)
	require.NoError(t, retry.RetryOnConflict(retry.DefaultRetry, func() error {
...
func removeAnnotationFromVectorizedV1Alpha1Cluster(ctx context.Context, t framework.TestingT, annotationKey, clusterName string) {
	key := t.ResourceKey(clusterName)
	require.NoError(t, retry.RetryOnConflict(retry.DefaultRetry, func() error {
		var cluster vectorizedv1alpha1.Cluster
		if err := t.Get(ctx, key, &cluster); err != nil {
...
func setAnnotationOnRedpandaV1Alpha2Redpanda(ctx context.Context, t framework.TestingT, annotationKey, annotationValue, clusterName string) {
	key := t.ResourceKey(clusterName)
	require.NoError(t, retry.RetryOnConflict(retry.DefaultRetry, func() error {
		var cluster redpandav1alpha2.Redpanda
		if err := t.Get(ctx, key, &cluster); err != nil {
...
func removeAnnotationFromRedpandaV1Alpha2Redpanda(ctx context.Context, t framework.TestingT, annotationKey, clusterName string) {
	key := t.ResourceKey(clusterName)
	require.NoError(t, retry.RetryOnConflict(retry.DefaultRetry, func() error {
		var cluster redpandav1alpha2.Redpanda
		if err := t.Get(ctx, key, &cluster); err != nil {
