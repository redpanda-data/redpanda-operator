Feature: Endpoint steering
  ...
  Scenario: Schema Registry endpoints follow registry health, not pod readiness
    ...
    Then the "registry" port of service "steering-clients" should publish pods "steering-1, steering-2"
    ...
    Then the "registry" port of service "steering-clients" should publish pods "steering-0, steering-1, steering-2"
    And the "schemaregistry" port of service "steering" should publish pods "steering-0, steering-1, steering-2"
  ...
  Scenario: V1 Cluster Services are steered the same way
    ...
    Then the "schema-registry" port of service "steering-v1-cluster" should publish pods "steering-v1-1, steering-v1-2"
    ...
    And pod "steering-v1-0" should be ready
    When I unblock ingress to pod "steering-v1-0"
    Then the "schema-registry" port of service "steering-v1-cluster" should publish pods "steering-v1-0, steering-v1-1, steering-v1-2"
