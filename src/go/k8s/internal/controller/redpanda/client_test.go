...
func (c *Client) GetAdminClientURL() string {
	for _, portForward := range c.adminClients {
		return fmt.Sprintf("127.0.0.1:%d", portForward.exposedPort)
	}

	return "missing-admin-clients"
}
