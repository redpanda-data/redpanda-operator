...
require (
	...
	github.com/wI2L/jsondiff v0.4.1-0.20230626084051-c85fb8ce3cac // indirect
...
replace github.com/fluxcd/source-controller/shim => github.com/redpanda-data/flux-controller-shim/source/shim v0.0.0-20231227162419-a45126310240

replace github.com/fluxcd/helm-controller v0.37.2 => github.com/alejandroesc/helm-controller v0.34.2-0.20231227161935-c30546b698fd
