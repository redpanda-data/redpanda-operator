	...
	bundles := []RBACBundle{
		...
		},
		{
			...
			RuleFiles: []string{
				...
				"files/rbac/managed-decommission.ClusterRole.yaml", // Deprecated but not yet removed.
	...
	bundles := []RBACBundle{
		...
		},
		{
			...
			RuleFiles: []string{
				...
				"files/rbac/managed-decommission.Role.yaml", // Deprecated but not yet removed.
				"files/rbac/pvcunbinder.Role.yaml",
			},
		},
		{
