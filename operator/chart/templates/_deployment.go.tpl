...
{{- $scrapeInterval := (get (fromJson (include "_shims.ptr_Deref" (dict "a" (list $values.connectController.monitoring.scrapeInterval "")))) "r") -}}
{{- if (ne $scrapeInterval "") -}}
{{- $_ := (set $defaults "--connect-monitoring-scrape-interval" $scrapeInterval) -}}
{{- end -}}
