...
{{- break -}}
{{- end -}}
{{- $endpoint := (mustMergeOverwrite (dict) (dict "port" "https" "path" "/metrics" "scheme" "https" "tlsConfig" (mustMergeOverwrite (dict "ca" (dict) "cert" (dict)) (mustMergeOverwrite (dict "ca" (dict) "cert" (dict)) (dict "insecureSkipVerify" true)) (dict)) "bearerTokenFile" "/var/run/secrets/kubernetes.io/serviceaccount/token")) -}}
