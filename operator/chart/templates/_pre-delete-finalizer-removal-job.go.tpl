...
{{- /* Transpiled by gotohelm from "github.com/redpanda-data/redpanda-operator/operator/chart/pre_delete_finalizer_removal_job.go" */ -}}

{{- define "operator.PreDeleteFinalizerRemovalJob" -}}
{{- $dot := (index .a 0) -}}
{{- range $_ := (list 1) -}}
{{- $_is_returning := false -}}
