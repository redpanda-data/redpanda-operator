...
![Version: 26.2.1-beta.1](https://img.shields.io/badge/Version-26.2.1--beta.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v26.2.1-beta.1](https://img.shields.io/badge/AppVersion-v26.2.1--beta.1-informational?style=flat-square)
...
```
{"enabled":false,"rulesEnabled":false}
```
