...
// StretchStatusUpdater represents a status updater for v2 clusters.
type StretchStatusUpdater struct{}

var _ ClusterStatusUpdater[StretchClusterWithPools, *StretchClusterWithPools] = (*StretchStatusUpdater)(nil)

// NewStretchStatusUpdater returns a StretchStatusUpdater.
func NewStretchStatusUpdater() *StretchStatusUpdater {
	return &StretchStatusUpdater{}
}

// Update updates the given Redpanda v2 cluster with the given cluster status.
func (m *StretchStatusUpdater) Update(cluster *StretchClusterWithPools, status *ClusterStatus) bool {
