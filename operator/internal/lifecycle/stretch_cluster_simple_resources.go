...
func NewStretchClusterSimpleResourceRenderer(mgr ctrl.Manager) *StretchClusterSimpleResourceRenderer {
...
func (m *StretchClusterSimpleResourceRenderer) Render(ctx context.Context, cluster *StretchClusterWithPools, clusterName string) ([]client.Object, error) {
	state, err := conversion.ConvertStretchClusterToRenderState(m.kubeConfig, &conversion.V2Defaulters{}, cluster.StretchCluster, cluster.NodePools, clusterName)
	if err != nil {
