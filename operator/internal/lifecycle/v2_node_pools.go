...
var _ NodePoolRenderer[redpandav1alpha2.ClusterWithPools, *redpandav1alpha2.ClusterWithPools] = (*V2NodePoolRenderer)(nil)
...
// isn't a node pool.
func (m *V2NodePoolRenderer) Render(ctx context.Context, cluster *redpandav1alpha2.ClusterWithPools) ([]*appsv1.StatefulSet, error) {
