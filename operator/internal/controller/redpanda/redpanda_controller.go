...
func (r *RedpandaReconciler) Reconcile(c context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if rp.Spec.ChartRef.UseFlux != nil && *rp.Spec.ChartRef.UseFlux {
		log.V(logger.TraceLevel).Info("useFlux: true is no longer supported. Please downgrade or unset `useFlux`")
		return ctrl.Result{}, nil
	}
...
func (r *RedpandaReconciler) reconcileResources(ctx context.Context, rp *v1alpha2.Redpanda) error {
...
func (r *RedpandaReconciler) ratelimitCondition(ctx context.Context, rp *v1alpha2.Redpanda, conditionType string) bool {
	...
	redpandaReady := apimeta.IsStatusConditionTrue(rp.Status.Conditions, v1alpha2.ReadyCondition)
...
func (r *RedpandaReconciler) reconcileGC(ctx context.Context, rp *v1alpha2.Redpanda, created map[gvkKey]struct{}) error {
	log := ctrl.LoggerFrom(ctx)
