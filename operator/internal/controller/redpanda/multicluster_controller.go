...
func (r *MulticlusterReconciler) Reconcile(ctx context.Context, req mcreconcile.Request) (result ctrl.Result, err error) {
	...
	if drifted, driftResult, driftErr := r.checkSpecConsistency(ctx, state, cluster, stretchCluster); drifted || driftErr != nil {
...
func (r *MulticlusterReconciler) checkSpecConsistency(ctx context.Context, state *stretchClusterReconciliationState, cl cluster.Cluster, sc *redpandav1alpha2.StretchCluster) (drifted bool, _ ctrl.Result, _ error) {
