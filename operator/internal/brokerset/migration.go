...
// backupStatefulSetPayload serializes only what
// restoreStatefulSetsFromBackup consumes. Marshaling a live object verbatim
// would embed resourceVersion/status churn and make staleness comparisons
// dirty on every pass.
