...
func RenderPodDisruptionBudget(_ context.Context, cluster *vectorizedv1alpha1.Cluster) (k8sclient.Object, error) {
	// Check if PDB is enabled - matching the behavior in pdb.go Ensure()
