...
func CreateConfiguration(
	...
	rpkSASLUser types.NamespacedName,
	...
	defaultProfileName := "rpk-default-profile"
	...
	if pandaCluster.IsSASLOnInternalEnabled() {
		...
		profile.KafkaAPI.SASL = &config.SASL{Mechanism: saslMechanism}
		cfg.RPK.AddFixup("profiles.0.kafka_api.sasl.user", fmt.Sprintf(`%s("KAFKA_RPK_USERNAME")`, clusterconfiguration.CELEnvString))
		cfg.Cluster.AddFixup(superusersConfigurationKey, fmt.Sprintf(`%s(it, %s("KAFKA_RPK_USERNAME"))`, clusterconfiguration.CELAppendYamlStringArray, clusterconfiguration.CELEnvString))
		_ = cfg.EnsureInitEnv(corev1.EnvVar{
			Name: "KAFKA_RPK_USERNAME",
			ValueFrom: &corev1.EnvVarSource{
				SecretKeyRef: &corev1.SecretKeySelector{
					LocalObjectReference: corev1.LocalObjectReference{
						Name: rpkSASLUser.Name,
					},
		...
		cfg.RPK.AddFixup("profiles.0.kafka_api.sasl.password", fmt.Sprintf(`%s("KAFKA_RPK_PASSWORD")`, clusterconfiguration.CELEnvString))
		_ = cfg.EnsureInitEnv(corev1.EnvVar{
			Name: "KAFKA_RPK_PASSWORD",
			ValueFrom: &corev1.EnvVarSource{
				SecretKeyRef: &corev1.SecretKeySelector{
					LocalObjectReference: corev1.LocalObjectReference{
						Name: rpkSASLUser.Name,
	...
	cfg.RPK.CurrentProfile = defaultProfileName
