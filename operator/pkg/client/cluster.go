...
// listener needs, which makes every needsTLS expression below load-bearing: it
// MUST match the TLS predicate inside the builder it feeds, or the builder is
// handed a nil provider for a listener it then tries to secure.
