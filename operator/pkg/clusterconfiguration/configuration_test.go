...
<<<<<<< HEAD:operator/pkg/clusterconfiguration/configuration_test.go
	// rpkcfg "github.com/redpanda-data/redpanda/src/go/rpk/pkg/config"
	vectorizedv1alpha1 "github.com/redpanda-data/redpanda-operator/operator/api/vectorized/v1alpha1"
	"github.com/redpanda-data/redpanda-operator/operator/pkg/clusterconfiguration"
=======
	"github.com/redpanda-data/redpanda-operator/pkg/clusterconfiguration"
>>>>>>> 4ef14158 (Allow complex schema type in addtitional configuration):pkg/clusterconfiguration/configuration_test.go
)
