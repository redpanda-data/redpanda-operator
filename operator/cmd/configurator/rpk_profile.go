...
func TemplateRPKProfileYaml(ctx context.Context, cloudExpander *pkgsecrets.CloudExpander, inFile, outFile, fixups string) error {
	if inFile == "" {
	...
	rpkProfile, err = applyFixups(ctx, rpkProfile, fixups, cloudExpander)
	if err != nil {
