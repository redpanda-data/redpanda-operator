...
func run(
	...
	if err = TemplateRPKProfileYaml(ctx, cloudExpander, filepath.Join(c.configSourceDir, "rpk.yaml"), c.rpkProfileDestination, filepath.Join(c.configSourceDir, "rpk.yaml.fixups")); err != nil {
