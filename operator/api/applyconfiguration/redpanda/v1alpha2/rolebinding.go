...
type RoleBindingApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *RoleBindingSpecApplyConfiguration   `json:"spec,omitempty"`
	Status                           *RoleBindingStatusApplyConfiguration `json:"status,omitempty"`
}
...
func (b *RoleBindingApplyConfiguration) WithSpec(value *RoleBindingSpecApplyConfiguration) *RoleBindingApplyConfiguration {
	b.Spec = value
	return b
}
...
func (b *RoleBindingApplyConfiguration) WithStatus(value *RoleBindingStatusApplyConfiguration) *RoleBindingApplyConfiguration {
	b.Status = value
	return b
}
