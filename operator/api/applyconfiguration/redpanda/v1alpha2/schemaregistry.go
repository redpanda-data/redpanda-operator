...
// SchemaRegistryApplyConfiguration represents a declarative configuration of the SchemaRegistry type for use
// with apply.
...
// SchemaRegistryApplyConfiguration constructs a declarative configuration of the SchemaRegistry type for use with
// apply.
...
func (b *SchemaRegistryApplyConfiguration) WithAppProtocol(value string) *SchemaRegistryApplyConfiguration {
...
func (b *SchemaRegistryApplyConfiguration) WithPort(value int32) *SchemaRegistryApplyConfiguration {
...
func (b *SchemaRegistryApplyConfiguration) WithPrefixTemplate(value string) *SchemaRegistryApplyConfiguration {
...
func (b *SchemaRegistryApplyConfiguration) WithExternal(entries map[string]*redpandav1alpha2.ExternalListener) *SchemaRegistryApplyConfiguration {
