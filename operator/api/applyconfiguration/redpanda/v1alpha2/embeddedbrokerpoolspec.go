...
type EmbeddedBrokerPoolSpecApplyConfiguration struct {
	...
	Services                   *BrokerPoolServicesApplyConfiguration       `json:"services,omitempty"`
	InitContainers             *BrokerPoolInitContainersApplyConfiguration `json:"initContainers,omitempty"`
...
func (b *EmbeddedBrokerPoolSpecApplyConfiguration) WithServices(value *BrokerPoolServicesApplyConfiguration) *EmbeddedBrokerPoolSpecApplyConfiguration {
	b.Services = value
	return b
}
...
func (b *EmbeddedBrokerPoolSpecApplyConfiguration) WithInitContainers(value *BrokerPoolInitContainersApplyConfiguration) *EmbeddedBrokerPoolSpecApplyConfiguration {
