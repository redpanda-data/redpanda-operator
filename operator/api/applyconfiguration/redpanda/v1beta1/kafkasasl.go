...
import (
	v1beta1 "github.com/redpanda-data/redpanda-operator/operator/api/redpanda/v1beta1"
)
...
type KafkaSASLApplyConfiguration struct {
	Mechanism    *v1beta1.SASLMechanism                  `json:"mechanism,omitempty"`
...
func (b *KafkaSASLApplyConfiguration) WithMechanism(value v1beta1.SASLMechanism) *KafkaSASLApplyConfiguration {
	b.Mechanism = &value
	return b
}
