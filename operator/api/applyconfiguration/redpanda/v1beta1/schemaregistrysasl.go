...
type SchemaRegistrySASLApplyConfiguration struct {
	...
	Mechanism *redpandav1beta1.SASLMechanism  `json:"mechanism,omitempty"`
...
func (b *SchemaRegistrySASLApplyConfiguration) WithMechanism(value redpandav1beta1.SASLMechanism) *SchemaRegistrySASLApplyConfiguration {
	b.Mechanism = &value
	return b
}
