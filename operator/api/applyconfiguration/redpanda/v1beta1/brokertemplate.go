...
type BrokerTemplateApplyConfiguration struct {
	...
	SetDataDirOwnership  *bool                                    `json:"setDataDirOwnership,omitempty"`
	ValidateFSXFS        *bool                                    `json:"validateFSXFS,omitempty"`
...
func (b *BrokerTemplateApplyConfiguration) WithSetDataDirOwnership(value bool) *BrokerTemplateApplyConfiguration {
	b.SetDataDirOwnership = &value
	return b
}

// WithValidateFSXFS sets the ValidateFSXFS field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the ValidateFSXFS field is set to the value of the last call.
func (b *BrokerTemplateApplyConfiguration) WithValidateFSXFS(value bool) *BrokerTemplateApplyConfiguration {
	b.ValidateFSXFS = &value
	return b
}
