...
const (
	...
	// progress on a Redpanda's status. Deliberately outside the generated
	// condition system: it is latched and needs several True-polarity
	// reasons (Complete, RolledBack). Matches the V1 Cluster's condition.
