...
func init() {
	ConvertConsoleToConsolePartialRenderValues = func(source *ConsoleValues) *v3.PartialRenderValues {
		...
		if source != nil {
			...
			if (*source).NameOverride != nil {
				xstring := *(*source).NameOverride
				consolePartialRenderValues.NameOverride = &xstring
			}
			...
			if (*source).FullnameOverride != nil {
				xstring2 := *(*source).FullnameOverride
				consolePartialRenderValues.FullnameOverride = &xstring2
			}
			...
			if (*source).PriorityClassName != nil {
				xstring3 := *(*source).PriorityClassName
				consolePartialRenderValues.PriorityClassName = &xstring3
			}
			consolePartialRenderValues.Config = conv_runtime_RawExtension_To_mapany((*source).Config)
		...
		return pConsolePartialRenderValues
	}
	ConvertStaticConfigToIR = func(source *StaticConfigurationSource) *ir.StaticConfigurationSource {
		...
		if source != nil {
			...
			irStaticConfigurationSource.Kafka = pV1alpha2KafkaAPISpecToPIrKafkaAPISpec((*source).Kafka)
			irStaticConfigurationSource.Admin = autoconv_AdminAPISpec_To_ir_AdminAPISpec((*source).Admin)
			irStaticConfigurationSource.SchemaRegistry = pV1alpha2SchemaRegistrySpecToPIrSchemaRegistrySpec((*source).SchemaRegistry)
			pIrStaticConfigurationSource = &irStaticConfigurationSource
		}
		return pIrStaticConfigurationSource
	}
	autoconv_AdminAPISpec_To_ir_AdminAPISpec = func(source *AdminAPISpec) *ir.AdminAPISpec {
		...
		if source != nil {
			...
			irAdminAPISpec.TLS = pV1alpha2CommonTLSToPIrCommonTLS((*source).TLS)
			irAdminAPISpec.Auth = pV1alpha2AdminSASLToPIrAdminAuth((*source).SASL)
...
func pV1alpha2AdminSASLToPIrAdminAuth(source *AdminSASL) *ir.AdminAuth {
	var pIrAdminAuth *ir.AdminAuth
	if source != nil {
		var irAdminAuth ir.AdminAuth
		irAdminAuth.Username = (*source).Username
		irAdminAuth.Password = v1alpha2SecretKeyRefToIrSecretKeyRef((*source).Password)
...
func pV1alpha2CommonTLSToPIrCommonTLS(source *CommonTLS) *ir.CommonTLS {
	var pIrCommonTLS *ir.CommonTLS
	if source != nil {
		var irCommonTLS ir.CommonTLS
		irCommonTLS.CaCert = conv_SecretKeyRef_To_ir_ObjectKeyRef((*source).CaCert)
		irCommonTLS.Cert = pV1alpha2SecretKeyRefToPIrSecretKeyRef((*source).Cert)
		irCommonTLS.Key = pV1alpha2SecretKeyRefToPIrSecretKeyRef((*source).Key)
...
func pV1alpha2KafkaAPISpecToPIrKafkaAPISpec(source *KafkaAPISpec) *ir.KafkaAPISpec {
	...
	if source != nil {
		...
		irKafkaAPISpec.TLS = pV1alpha2CommonTLSToPIrCommonTLS((*source).TLS)
		irKafkaAPISpec.SASL = pV1alpha2KafkaSASLToPIrKafkaSASL((*source).SASL)
		pIrKafkaAPISpec = &irKafkaAPISpec
	}
	return pIrKafkaAPISpec
}
func pV1alpha2KafkaSASLToPIrKafkaSASL(source *KafkaSASL) *ir.KafkaSASL {
	var pIrKafkaSASL *ir.KafkaSASL
	if source != nil {
		var irKafkaSASL ir.KafkaSASL
		irKafkaSASL.Username = (*source).Username
		irKafkaSASL.Password = v1alpha2SecretKeyRefToIrSecretKeyRef((*source).Password)
		irKafkaSASL.Mechanism = ir.SASLMechanism((*source).Mechanism)
		irKafkaSASL.OAUth = v1alpha2KafkaSASLOAuthBearerToIrKafkaSASLOAuthBearer((*source).OAUth)
		irKafkaSASL.GSSAPIConfig = v1alpha2KafkaSASLGSSAPIToIrKafkaSASLGSSAPI((*source).GSSAPIConfig)
		irKafkaSASL.AWSMskIam = v1alpha2KafkaSASLAWSMskIamToIrKafkaSASLAWSMskIam((*source).AWSMskIam)
...
func pV1alpha2SchemaRegistrySASLToPIrSchemaRegistrySASL(source *SchemaRegistrySASL) *ir.SchemaRegistrySASL {
	...
	if source != nil {
		...
		irSchemaRegistrySASL.Password = v1alpha2SecretKeyRefToIrSecretKeyRef((*source).Password)
		irSchemaRegistrySASL.AuthToken = v1alpha2SecretKeyRefToIrSecretKeyRef((*source).AuthToken)
...
func pV1alpha2SchemaRegistrySpecToPIrSchemaRegistrySpec(source *SchemaRegistrySpec) *ir.SchemaRegistrySpec {
	...
	if source != nil {
		...
		irSchemaRegistrySpec.TLS = pV1alpha2CommonTLSToPIrCommonTLS((*source).TLS)
		irSchemaRegistrySpec.SASL = pV1alpha2SchemaRegistrySASLToPIrSchemaRegistrySASL((*source).SASL)
		pIrSchemaRegistrySpec = &irSchemaRegistrySpec
	}
	return pIrSchemaRegistrySpec
}
func pV1alpha2SecretKeyRefToPIrSecretKeyRef(source *SecretKeyRef) *ir.SecretKeyRef {
...
func v1alpha2KafkaSASLAWSMskIamToIrKafkaSASLAWSMskIam(source KafkaSASLAWSMskIam) ir.KafkaSASLAWSMskIam {
	var irKafkaSASLAWSMskIam ir.KafkaSASLAWSMskIam
	irKafkaSASLAWSMskIam.AccessKey = source.AccessKey
	irKafkaSASLAWSMskIam.SecretKey = v1alpha2SecretKeyRefToIrSecretKeyRef(source.SecretKey)
	irKafkaSASLAWSMskIam.SessionToken = v1alpha2SecretKeyRefToIrSecretKeyRef(source.SessionToken)
	irKafkaSASLAWSMskIam.UserAgent = source.UserAgent
	return irKafkaSASLAWSMskIam
}
func v1alpha2KafkaSASLGSSAPIToIrKafkaSASLGSSAPI(source KafkaSASLGSSAPI) ir.KafkaSASLGSSAPI {
	...
	irKafkaSASLGSSAPI.Password = v1alpha2SecretKeyRefToIrSecretKeyRef(source.Password)
	irKafkaSASLGSSAPI.Realm = source.Realm
	irKafkaSASLGSSAPI.EnableFast = source.EnableFast
	return irKafkaSASLGSSAPI
}
func v1alpha2KafkaSASLOAuthBearerToIrKafkaSASLOAuthBearer(source KafkaSASLOAuthBearer) ir.KafkaSASLOAuthBearer {
	var irKafkaSASLOAuthBearer ir.KafkaSASLOAuthBearer
	irKafkaSASLOAuthBearer.Token = v1alpha2SecretKeyRefToIrSecretKeyRef(source.Token)
...
func v1alpha2SecretKeyRefToIrSecretKeyRef(source SecretKeyRef) ir.SecretKeyRef {
	var irSecretKeyRef ir.SecretKeyRef
	irSecretKeyRef.Name = source.Name
	irSecretKeyRef.Key = source.Key
