...
// "Ready" - This condition indicates whether a cluster is ready to serve any
// traffic. This can happen, for example if a cluster is partially degraded but
// still can process requests.
//
...
// "Healthy" - This condition indicates whether a cluster is healthy as defined
// by the Redpanda Admin API's cluster health endpoint.
//
// This condition defaults to "Unknown" with a reason of "NotReconciled" and
// must be set by a controller when it subsequently reconciles a cluster.
// +statusType
...
// "LicenseValid" - This condition indicates whether a cluster has a valid
// license.
//
// This condition defaults to "Unknown" with a reason of "NotReconciled" and
// must be set by a controller when it subsequently reconciles a cluster.
...
// "ResourcesSynced" - This condition indicates whether the Kubernetes resources
// for a cluster have been synchronized.
//
...
// "ConfigurationApplied" - This condition indicates whether cluster
...
// "Quiesced" - This condition is used as to indicate that the cluster is no
// longer reconciling due to it being in a finalized state for the current
// generation.
//
// This condition defaults to "False" with a reason of "NotReconciled" and must
// be set by a controller when it subsequently reconciles a cluster.
...
// "Stable" - This condition is used as a roll-up status for any sort of
...
// "Bound" - This condition indicates whether a node pool is bound to a known
// Redpanda cluster.
//
// This condition defaults to "Unknown" with a reason of "NotReconciled" and
...
// "Deployed" - This condition indicates whether a node pool has been deployed
// for a known Redpanda cluster.
//
// This condition defaults to "Unknown" with a reason of "NotReconciled" and
// must be set by a controller when it subsequently reconciles a node pool.
// +statusType
...
// "Quiesced" - This condition is used as to indicate that the node pool is no
// longer reconciling due to it being in a finalized state for the current
// generation.
//
// This condition defaults to "False" with a reason of "NotReconciled" and must
