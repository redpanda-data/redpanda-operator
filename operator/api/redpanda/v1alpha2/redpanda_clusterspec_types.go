...
type RedpandaClusterSpec struct {
	...
	// Assigns custom annotations to all resources generated by the Redpanda Helm chart, except the StatefulSet Pod template. Specify annotations as key/value pairs.
...
type RedpandaConsole struct {
	...
	FullNameOverride *string           `json:"fullnameOverride,omitempty"`
	CommonLabels     map[string]string `json:"commonLabels,omitempty"`
	// Assigns custom annotations to all Redpanda Console resources. Specify annotations as key/value pairs.
	CommonAnnotations map[string]string `json:"commonAnnotations,omitempty"`
