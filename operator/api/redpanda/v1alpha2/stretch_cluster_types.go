...
type StretchClusterSpec struct {
	...
	// InternalServiceAnnotations is applied to the headless ClusterIP
	...
	// All pods across all NodePools share this image (mismatches are expected
	// only transiently during rolling upgrades).
	Image *RedpandaImage `json:"image,omitempty"`

	// Specifies credentials for a private image repository. For details, see
	// https://kubernetes.io/docs/tasks/configure-pod-container/pull-image-private-registry/.
	// Acts as a default for all NodePools; may be overridden per-NodePool via
	// NodePool.Spec.ImagePullSecrets.
	...
	// Defines cross-cluster networking settings.
