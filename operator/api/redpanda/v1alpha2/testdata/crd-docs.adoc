...
.Resource Types
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-pipeline[$$Connect$$]
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-connectspec[$$PipelineSpec$$]
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-consolespec[$$ConsoleSpec$$]
...
Pipeline defines a Redpanda Pipeline pipeline managed by the operator.
...
| *`metadata`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#objectmeta-v1-meta[$$ObjectMeta$$]__ | Refer to Kubernetes API documentation for fields of `metadata`.
 |  | 
| *`spec`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-connectspec[$$PipelineSpec$$]__ | Spec defines the desired state of the Pipeline pipeline. + |  | 
| *`status`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-connectstatus[$$PipelineStatus$$]__ | Status represents the current observed state of the Pipeline pipeline. + |  | 
|===
...
PipelineSpec defines the desired state of a Redpanda Pipeline pipeline.
...
|===
| Field | Description | Default | Validation
| *`configYaml`* __string__ | ConfigYAML is the Redpanda Pipeline pipeline configuration in YAML format. +
...
PipelineStatus defines the observed state of a Pipeline resource.
...
|===
| Field | Description | Default | Validation
| *`observedGeneration`* __integer__ | ObservedGeneration is the last observed generation of the Pipeline resource. + |  | Optional: \{} +

| *`conditions`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#condition-v1-meta[$$Condition$$] array__ | Conditions holds the conditions for the Pipeline resource. + |  | Optional: \{} +
