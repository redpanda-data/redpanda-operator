...
|===
| Reason | Description |
| `Applied` | This reason is used with the "ConfigurationApplied" condition when it +
evaluates to True because a cluster has had its cluster configuration +
parameters applied. +
 |
| `NotApplied` | This reason is used with the "ConfigurationApplied" condition when it +
...
when no brokers have been created and thus we can't attempt a configuration. +
 |
| `Error` | This reason is used when a cluster has only been partially reconciled and we +
...
condition "Quiesced" will be False with a reason of "SillReconciling". +
 |
| `TerminalError` | This reason is used when a cluster has only been partially reconciled and we +
...
|===
| Reason | Description |
| `Healthy` | This reason is used with the "Healthy" condition when it evaluates to True +
because a cluster's health endpoint says the cluster is healthy. +
 |
| `NotHealthy` | This reason is used with the "Healthy" condition when it evaluates to False +
...
|===
| Reason | Description |
| `Valid` | This reason is used with the "LicenseValid" condition when it evaluates to +
True because a cluster has a valid license. +
 |
| `Expired` | This reason is used with the "LicenseValid" condition when it evaluates to +
False because a cluster has an expired license. +
 |
| `NotPresent` | This reason is used with the "LicenseValid" condition when it evaluates to +
...
|===
| Reason | Description |
| `Quiesced` | This reason is used with the "Quiesced" condition when it evaluates to True +
because the operator has finished reconciling the cluster at its current +
generation. +
 |
| `StillReconciling` | This reason is used with the "Quiesced" condition when it evaluates to False +
...
|===
| Reason | Description |
| `Ready` | This reason is used with the "Ready" condition when it evaluates to True +
because a cluster can service traffic. +
 |
| `NotReady` | This reason is used with the "Ready" condition when it evaluates to False +
...
|===
| Reason | Description |
| `Synced` | This reason is used with the "ResourcesSynced" condition when it evaluates to +
...
|===
| Reason | Description |
| `Stable` | This reason is used with the "Stable" condition when it evaluates to True +
because all dependent conditions also evaluate to True. +
 |
| `Unstable` | This reason is used with the "Stable" condition when it evaluates to True +
...
|===
| Reason | Description |
| `Bound` | This reason is used with the "Bound" condition when it evaluates to True +
because a node pool is bound to a cluster. +
 |
| `NotBound` | This reason is used with the "Bound" condition when it evaluates to False +
because a node pool is not bound to a cluster. +
 |
| `Error` | This reason is used when a node pool has only been partially reconciled and +
we have early returned due to a retryable error occurring prior to applying +
the desired node pool state. +
 |
| `TerminalError` | This reason is used when a node pool has only been partially reconciled and +
...
|===
| Reason | Description |
| `Deployed` | This reason is used with the "Deployed" condition when it evaluates to True +
because a node pool has been fully deployed for a cluster. +
 |
| `Scaling` | This reason is used with the "Deployed" condition when it evaluates to False +
because a node pool has not yet been fully deployed for a cluster. +
 |
| `NotDeployed` | This reason is used with the "Deployed" condition when it evaluates to False +
