...
registry. + |  | 
| *`tls`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-shadowlinkschemaregistrytls[$$ShadowLinkSchemaRegistryTLS$$]__ | TLS settings used to connect to the source schema registry. + |  | 
...
| *`contextMappings`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-shadowlinkschemaregistrycontextmapping[$$ShadowLinkSchemaRegistryContextMapping$$] array__ | Maps source contexts to destination contexts on the shadow cluster. +
...
|===
| Field | Description | Default | Validation
| *`enabled`* __boolean__ | Enabled controls whether schemas are replicated from the source +
...
API. Set to false to turn schema replication off. + | true | 
| *`schema_registry_shadowing_mode`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-shadowlinkschemaregistrysyncoptionsmode[$$ShadowLinkSchemaRegistrySyncOptionsMode$$]__ | Deprecated: schemas now replicate in "topic" mode by default. Use +
...
[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-shadowlinkschemaregistrytls"]
==== ShadowLinkSchemaRegistryTLS
...
|===
| Field | Description | Default | Validation
| *`enabled`* __boolean__ | Enabled turns on TLS for the connection to the source schema registry. +
...
| *`caCert`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-valuesource[$$ValueSource$$]__ | CaCert references the certificate authority used to verify the source +
schema registry's TLS certificate. May reference a Kubernetes Secret. + |  | 
| *`cert`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-valuesource[$$ValueSource$$]__ | Cert references the client public certificate used to establish an mTLS +
connection to the source schema registry. May reference a Kubernetes +
Secret. + |  | 
| *`key`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-valuesource[$$ValueSource$$]__ | Key references the client private key used to establish an mTLS +
...
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-shadowlinkschemaregistrytls[$$ShadowLinkSchemaRegistryTLS$$]
****
