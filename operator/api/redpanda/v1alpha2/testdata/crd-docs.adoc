...
| *`commonAnnotations`* __object (keys:string, values:string)__ |  |  | 
...
| *`commonAnnotations`* __object (keys:string, values:string)__ | Assigns custom annotations to all resources generated by the Redpanda Helm chart, except the StatefulSet Pod template. Specify annotations as key/value pairs. + |  | 
...
| *`fullnameOverride`* __string__ | Specifies a full custom name, which overrides the entire naming convention including release name and chart name. + |  | 
| *`commonLabels`* __object (keys:string, values:string)__ |  |  | 
| *`commonAnnotations`* __object (keys:string, values:string)__ | Assigns custom annotations to all Redpanda Console resources. Specify annotations as key/value pairs. + |  | 
