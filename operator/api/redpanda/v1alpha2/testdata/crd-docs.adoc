...
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-redpandarolebinding[$$RedpandaRoleBinding$$]
...
| *`livenessProbe`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#probe-v1-core[$$Probe$$]__ |  |  | 
| *`readinessProbe`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#probe-v1-core[$$Probe$$]__ |  |  | 
...
[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-redpandarolebinding"]
==== RedpandaRoleBinding
...
| Field | Description | Default | Validation
| *`apiVersion`* __string__ | `cluster.redpanda.com/v1alpha2` | |
| *`kind`* __string__ | `RedpandaRoleBinding` | |
| *`kind`* __string__ | Kind is a string value representing the REST resource this object represents. +
Servers may infer this from the endpoint the client submits requests to. +
Cannot be updated. +
In CamelCase. +
...
| *`metadata`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#objectmeta-v1-meta[$$ObjectMeta$$]__ | Refer to Kubernetes API documentation for fields of `metadata`.
 |  | 
| *`spec`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-redpandarolebindingspec[$$RedpandaRoleBindingSpec$$]__ | Defines the desired state of the RoleBinding. + |  | 
| *`status`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-redpandarolebindingstatus[$$RedpandaRoleBindingStatus$$]__ | Represents the current status of the RoleBinding. + | { conditions:[map[lastTransitionTime:1970-01-01T00:00:00Z message:Waiting for controller reason:NotReconciled status:Unknown type:Synced]] } | 
|===


[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-redpandarolebindingspec"]
==== RedpandaRoleBindingSpec
...
|===
| Field | Description | Default | Validation
| *`roleRef`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-roleref[$$RoleRef$$]__ | RoleRef references the Role this binding applies to. +
The referenced Role must exist in the same namespace. + |  | 
| *`principals`* __string array__ | Principals defines the list of users assigned to the referenced role. +
...
Only "User:" prefix or no prefix is currently supported. + |  | MaxItems: 1024 +
MinItems: 1 +

|===


[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-redpandarolebindingstatus"]
==== RedpandaRoleBindingStatus
...
| *`conditions`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#condition-v1-meta[$$Condition$$] array__ | Conditions holds the conditions for the RoleBinding. +
...
[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-roleref"]
==== RoleRef
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-redpandarolebindingspec[$$RedpandaRoleBindingSpec$$]
****

[cols="20a,50a,15a,15a", options="header"]
|===
| Field | Description | Default | Validation
| *`name`* __string__ | Name of the Role. + |  | MinLength: 1 +
...
Format: Type:Name (e.g., User:john, User:jane). If type is omitted, defaults to User. +
Only "User:" prefix or no prefix is currently supported. + |  | MaxItems: 4096 +
...
to be cleaned up. + |  | 
| *`principals`* __string array__ | Principals contains the list of principals that were last successfully +
synced to Redpanda. This includes principals from both the Role's spec +
and all RoleBindings that reference this Role. + |  | MaxItems: 1024 +
