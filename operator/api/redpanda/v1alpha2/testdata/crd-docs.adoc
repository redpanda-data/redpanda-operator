...
| *`useFlux`* __boolean__ | `useFlux` controls whether or not a vendored version of FluxCD is +
...
_Underlying type:_ _xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-struct-cert -string -json-cert-omitempty- enabled -bool -json-enabled-omitempty- secretref -string -json-secretref-omitempty- requireclientauth -bool -json-requireclientauth-omitempty- truststore -truststore -json-truststore-omitempty-[$$struct{Cert *string "json:\"cert,omitempty\""; Enabled *bool "json:\"enabled,omitempty\""; SecretRef *string "json:\"secretRef,omitempty\""; RequireClientAuth *bool "json:\"requireClientAuth,omitempty\""; TrustStore *TrustStore "json:\"trustStore,omitempty\""}$$]_
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-redpandaclusterspecalt[$$RedpandaClusterSpecAlt$$]
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-redpandaspec[$$RedpandaSpec$$]
****
