...
[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-brokerperpodserviceoverride"]
==== BrokerPerPodServiceOverride
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-brokerperpodservices[$$BrokerPerPodServices$$]
****
...
[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-brokerperpodservices"]
==== BrokerPerPodServices
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-brokerpoolservices[$$BrokerPoolServices$$]
****

[cols="20a,50a,15a,15a", options="header"]
|===
| Field | Description | Default | Validation
| *`local`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-brokerperpodserviceoverride[$$BrokerPerPodServiceOverride$$]__ | Local overrides are applied to per-pod Services for pods in the local cluster. + |  | 
| *`remote`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-brokerperpodserviceoverride[$$BrokerPerPodServiceOverride$$]__ | Remote overrides are applied to per-pod Services for pods in remote clusters. + |  | 
|===


[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-brokerpoolconfigurator"]
==== BrokerPoolConfigurator
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-brokerpoolinitcontainers[$$BrokerPoolInitContainers$$]
****
...
[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-brokerpoolfsvalidator"]
...
[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-brokerpoolinitcontainers"]
==== BrokerPoolInitContainers
...
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-redpandabrokerpoolspec[$$RedpandaBrokerPoolSpec$$]
****

[cols="20a,50a,15a,15a", options="header"]
|===
| Field | Description | Default | Validation
| *`fsValidator`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-brokerpoolfsvalidator[$$BrokerPoolFSValidator$$]__ |  |  | 
| *`setDataDirOwnership`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-brokerpoolsetdatadirownership[$$BrokerPoolSetDataDirOwnership$$]__ |  |  | 
| *`configurator`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-brokerpoolconfigurator[$$BrokerPoolConfigurator$$]__ |  |  | 
|===


[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-brokerpoolservices"]
==== BrokerPoolServices
...
|===
| Field | Description | Default | Validation
| *`perPod`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-brokerperpodservices[$$BrokerPerPodServices$$]__ | PerPod configures overrides for per-pod ClusterIP Services. + |  | 
|===


[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-brokerpoolsetdatadirownership"]
...
|===
| Field | Description | Default | Validation
| *`additionalSelectorLabels`* __object (keys:string, values:string)__ | Chart default: {} + |  | 
| *`replicas`* __integer__ | Chart default: 3 + |  | 
| *`additionalRedpandaCmdFlags`* __string array__ | Chart default: [] + |  | 
| *`podTemplate`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-podtemplate[$$PodTemplate$$]__ | Chart default: +
labels: {} +
annotations: {} +
spec: +
securityContext: {} +
...
"app.kubernetes.io/instance":  '{{ .Release.Name }}' +
"app.kubernetes.io/name":      '{{ include "redpanda.name" . }}' + |  | 
| *`services`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-brokerpoolservices[$$BrokerPoolServices$$]__ | Services configures overrides for Services created by the operator. + |  | 
| *`initContainers`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-brokerpoolinitcontainers[$$BrokerPoolInitContainers$$]__ |  |  | 
| *`image`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-redpandaimage[$$RedpandaImage$$]__ | Default: +
repository: docker.redpanda.com/redpandadata/redpanda +
tag: {{.redpandaVersion}} + |  | 
| *`sidecarImage`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-redpandaimage[$$RedpandaImage$$]__ | Default: +
repository: docker.redpanda.com/redpandadata/redpanda-operator +
tag: {{.operatorVersion}} + |  | 
| *`initContainerImage`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-initcontainerimage[$$InitContainerImage$$]__ | Chart default: +
repository: busybox +
tag: latest + |  | 
| *`clusterDomain`* __string__ | ClusterDomain customizes the K8s cluster's DNS suffix used to generate +
internal pod domains (e.g. "cluster.local"). Defaults to "cluster.local". + |  | 
| *`tls`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-tls[$$TLS$$]__ | TLS configures TLS settings for listeners on this broker pool's pods. +
Secret references resolve in the K8s cluster where this pool runs. + |  | 
| *`external`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-external[$$External$$]__ | External configures external access (NodePort, LoadBalancer, advertised +
addresses) for this broker pool's pods. + |  | 
| *`rbac`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-rbac[$$RBAC$$]__ | RBAC configures Role Based Access Control resources created in the +
K8s cluster where this broker pool runs. + |  | 
| *`serviceAccount`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-serviceaccount[$$ServiceAccount$$]__ | ServiceAccount configures the K8s ServiceAccount used by pods in this +
broker pool. Cloud workload-identity annotations belong here. + |  | 
| *`monitoring`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-monitoring[$$Monitoring$$]__ | Monitoring configures the ServiceMonitor created in the K8s cluster +
where this broker pool runs. + |  | 
| *`imagePullSecrets`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#localobjectreference-v1-core[$$LocalObjectReference$$] array__ | ImagePullSecrets overrides StretchCluster.Spec.ImagePullSecrets for +
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-redpandabrokerpoolstatus[$$RedpandaBrokerPoolStatus$$]
****
...
| *`metadata`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#objectmeta-v1-meta[$$ObjectMeta$$]__ | Refer to Kubernetes API documentation for fields of `metadata`.
 |  | 
| *`spec`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-redpandabrokerpoolspec[$$RedpandaBrokerPoolSpec$$]__ |  |  | 
| *`status`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-redpandabrokerpoolstatus[$$RedpandaBrokerPoolStatus$$]__ |  | { conditions:[map[lastTransitionTime:1970-01-01T00:00:00Z message:Waiting for controller reason:NotReconciled status:Unknown type:Bound] map[lastTransitionTime:1970-01-01T00:00:00Z message:Waiting for controller reason:NotReconciled status:Unknown type:Deployed] map[lastTransitionTime:1970-01-01T00:00:00Z message:Waiting for controller reason:NotReconciled status:Unknown type:Quiesced] map[lastTransitionTime:1970-01-01T00:00:00Z message:Waiting for controller reason:NotReconciled status:Unknown type:Stable]] } | 
|===


[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-redpandabrokerpoolspec"]
==== RedpandaBrokerPoolSpec
...
[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-redpandabrokerpoolstatus"]
==== RedpandaBrokerPoolStatus
...
| *`runningReplicas`* __integer__ | RunningReplicas is the number of replicas that are actively in a running +
state. + |  | 
| *`deployedGeneration`* __integer__ | DeployedGeneration represents the generation of the RedpandaBrokerPool +
CRD that is currently deployed as a StatefulSet. + |  | 
| *`conditions`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#condition-v1-meta[$$Condition$$] array__ | Conditions holds the conditions for the broker pool. + |  | Optional: \{} +
