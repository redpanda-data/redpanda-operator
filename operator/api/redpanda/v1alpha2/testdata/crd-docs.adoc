...
| *`internalRoleName`* __string__ | InternalRoleName specifies the internal role name to be used in Redpanda, prefixed with "__". +
...
maintaining a user-friendly external name. + |  | MaxLength: 253 +
