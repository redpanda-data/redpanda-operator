...
| *`gateway`* __boolean__ | Opts this listener into Gateway API TLSRoute mode. Requires external.gateway to be configured. When true, a TLSRoute is created for this listener instead of including it in NodePort/LoadBalancer services. + |  | 
