...
| *`host`* __string__ |  | * | 
| *`operation`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-acloperation[$$ACLOperation$$]__ |  |  | 
| *`permissionType`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-acltype[$$ACLType$$]__ |  |  | Enum: [allow deny] +

| *`principal`* __string__ |  | * | 
|===
...
|===
| Field | Description | Default | Validation
| *`accessFilter`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-aclaccessfilter[$$ACLAccessFilter$$]__ |  |  | 
| *`resourceFilter`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-aclresourcefilter[$$ACLResourceFilter$$]__ |  |  | 
|===
...
[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-autocreatetopics"]
==== AutoCreateTopics
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-mirrortopicoptions[$$MirrorTopicOptions$$]
****

[cols="20a,50a,15a,15a", options="header"]
|===
| Field | Description | Default | Validation
| *`enabled`* __boolean__ |  | false | 
| *`topicFilters`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-topicfilter[$$TopicFilter$$] array__ |  |  | 
|===
...
[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-consumergroupfilter"]
==== ConsumerGroupFilter
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-consumergroupfilter[$$ConsumerGroupFilter$$]
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-topicfilter[$$TopicFilter$$]
****
...
[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-linkmode"]
==== LinkMode
...
[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-mirrortopic"]
==== MirrorTopic
...
| Field | Description | Default | Validation
| *`name`* __string__ |  |  | 
| *`state`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-mirrortopicstate[$$MirrorTopicState$$]__ |  | active | Enum: [pause promote failover active] +

| *`configs`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#rawextension-runtime-pkg[$$RawExtension$$]__ |  |  | 
| *`replicationFactor`* __integer__ |  |  | 
| *`sourceTopicName`* __string__ |  |  | 
|===


[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-mirrortopicoptions"]
==== MirrorTopicOptions
...
|===
| Field | Description | Default | Validation
| *`autoCreateTopics`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-autocreatetopics[$$AutoCreateTopics$$]__ |  |  | 
| *`prefix`* __string__ |  |  | 
|===


[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-mirrortopicstate"]
==== MirrorTopicState
...
.Validation:
- Enum: [pause promote failover active]

.Appears In:
****
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-mirrortopic[$$MirrorTopic$$]
****
...
| *`status`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-nodepoolstatus[$$NodePoolStatus$$]__ |  |  | 
|===
...
|===
| Field | Description | Default | Validation
| *`linkMode`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-linkmode[$$LinkMode$$]__ |  | source | Enum: [destination source] +
...
| *`destinationCluster`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-clustersource[$$ClusterSource$$]__ |  |  | 
| *`consumerGroupFilters`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-consumergroupfilter[$$ConsumerGroupFilter$$] array__ |  |  | 
| *`aclFilters`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-aclfilter[$$ACLFilter$$] array__ |  |  | 
| *`configs`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#rawextension-runtime-pkg[$$RawExtension$$]__ |  |  | 
| *`mirrorTopics`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-mirrortopic[$$MirrorTopic$$] array__ |  |  | 
| *`mirrorTopicOptions`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-mirrortopicoptions[$$MirrorTopicOptions$$]__ |  |  | 
|===
...
[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-topicfilter"]
==== TopicFilter
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-autocreatetopics[$$AutoCreateTopics$$]
****
