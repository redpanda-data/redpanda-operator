...
.Resource Types
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-connect[$$Connect$$]
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-connectspec[$$ConnectSpec$$]
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-consolespec[$$ConsoleSpec$$]
...
[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-connect"]
==== Connect
...
| *`metadata`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#objectmeta-v1-meta[$$ObjectMeta$$]__ | Refer to Kubernetes API documentation for fields of `metadata`.
 |  | 
| *`spec`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-connectspec[$$ConnectSpec$$]__ | Spec defines the desired state of the Connect pipeline. + |  | 
| *`status`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-connectstatus[$$ConnectStatus$$]__ | Status represents the current observed state of the Connect pipeline. + |  | 
|===


[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-connectspec"]
==== ConnectSpec
...
| *`topologySpreadConstraints`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#topologyspreadconstraint-v1-core[$$TopologySpreadConstraint$$] array__ | TopologySpreadConstraints controls how pipeline pods are spread across topology domains such as availability zones. + |  | Optional: \{} +

| *`zones`* __string array__ | Zones specifies the availability zones across which pipeline pods should be spread. +
When set, the controller configures a node affinity to schedule pods only on nodes in these zones and a topology spread constraint to distribute pods evenly across zones. +
The zone label used is "topology.kubernetes.io/zone". + |  | Optional: \{} +

| *`licenseSecretRef`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#secretkeyselector-v1-core[$$SecretKeySelector$$]__ | LicenseSecretRef is a reference to a Secret containing the Redpanda enterprise license. +
The license is required for Redpanda Connect to operate. +
The Secret must contain a key (default "license") with the license data. + |  | Required: \{} +
...
[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-connectstatus"]
==== ConnectStatus
...
| *`phase`* __string__ | Phase describes the current phase of the pipeline lifecycle. + |  | Optional: \{} +
