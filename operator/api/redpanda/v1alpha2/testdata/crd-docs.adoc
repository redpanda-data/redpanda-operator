...
| *`managedSrAcls`* __boolean__ | ManagedSRACLs returns whether the role has managed Schema Registry ACLs +
...
to be cleaned up. + |  | 
| *`managedSrAcls`* __boolean__ | ManagedSRACLs returns whether the user has managed Schema Registry ACLs +
that need to be cleaned up. + |  | 
|===
