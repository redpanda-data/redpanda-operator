...
"app.kubernetes.io/instance":  '{{ .Release.Name }}' +
"app.kubernetes.io/name":      '{{ include "redpanda.name" . }}' + |  | 
| *`initContainers`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-poolinitcontainers[$$PoolInitContainers$$]__ |  |  | 
