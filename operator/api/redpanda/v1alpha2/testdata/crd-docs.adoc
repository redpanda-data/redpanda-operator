...
[id="{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-pipelinesaslcredentials"]
==== PipelineSASLCredentials
...
|===
| Field | Description | Default | Validation
| *`mechanism`* __string__ | Mechanism is the SASL mechanism (e.g., SCRAM-SHA-256, SCRAM-SHA-512). + |  | Required: \{} +

| *`username`* __string__ | Username is the SASL username. + |  | Required: \{} +

| *`password`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-valuesource[$$ValueSource$$]__ | Password references the SASL password. Supports Kubernetes Secrets, +
...
native cloud secret integration. + |  | Required: \{} +
...
|===
| Field | Description | Default | Validation
| *`configYaml`* __string__ | ConfigYAML is the Redpanda Connect pipeline configuration in YAML format. +
This follows the standard Redpanda Connect configuration schema with +
input, pipeline, and output sections. + |  | Required: \{} +
...
| *`env`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#envvar-v1-core[$$EnvVar$$] array__ | Env specifies additional environment variables for the pipeline container. + |  | Optional: \{} +

| *`secretRef`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#localobjectreference-v1-core[$$LocalObjectReference$$] array__ | SecretRef is a list of Kubernetes Secrets to expose as environment variables +
...
| *`credentials`* __xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-pipelinesaslcredentials[$$PipelineSASLCredentials$$]__ | Credentials specifies SASL credentials for the pipeline to authenticate +
...
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-kafkasaslgssapi[$$KafkaSASLGSSAPI$$]
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-kafkasasloauthbearer[$$KafkaSASLOAuthBearer$$]
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-pipelinesaslcredentials[$$PipelineSASLCredentials$$]
- xref:{anchor_prefix}-github-com-redpanda-data-redpanda-operator-operator-api-redpanda-v1alpha2-schemaregistrysasl[$$SchemaRegistrySASL$$]
****
