...
| *`licenseSecretRef`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#secretkeyselector-v1-core[$$SecretKeySelector$$]__ | LicenseSecretRef is an optional reference to a Secret containing the Redpanda enterprise license. +
...
If not set, the operator-level license (configured via enterprise.licenseSecretRef in the operator Helm chart values) will be used. + |  | Optional: \{} +
