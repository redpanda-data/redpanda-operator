...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RedpandaClusterSpecAlt) DeepCopyInto(out *RedpandaClusterSpecAlt) {
	*out = *in
	if in.NameOverride != nil {
		in, out := &in.NameOverride, &out.NameOverride
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RedpandaClusterSpecAlt.
func (in *RedpandaClusterSpecAlt) DeepCopy() *RedpandaClusterSpecAlt {
	if in == nil {
		return nil
	}
	out := new(RedpandaClusterSpecAlt)
	in.DeepCopyInto(out)
	return out
}
