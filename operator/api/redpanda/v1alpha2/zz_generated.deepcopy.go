...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterWithPools) DeepCopyInto(out *ClusterWithPools) {
	*out = *in
	if in.Redpanda != nil {
	...
	if in.NodePools != nil {
		...
		*out = make([]*v1alpha3.NodePool, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(v1alpha3.NodePool)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterWithPools.
func (in *ClusterWithPools) DeepCopy() *ClusterWithPools {
	if in == nil {
		return nil
	}
	out := new(ClusterWithPools)
	in.DeepCopyInto(out)
	return out
}
