...
func (in *NetworkPolicy) DeepCopyInto(out *NetworkPolicy) {
	*out = *in
	...
	if in.OperatorPeer != nil {
		in, out := &in.OperatorPeer, &out.OperatorPeer
		*out = new(networkingv1.NetworkPolicyPeer)
		(*in).DeepCopyInto(*out)
	}
	if in.AdminPeers != nil {
		in, out := &in.AdminPeers, &out.AdminPeers
		*out = make([]networkingv1.NetworkPolicyPeer, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ClientPeers != nil {
		in, out := &in.ClientPeers, &out.ClientPeers
		*out = make([]networkingv1.NetworkPolicyPeer, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
