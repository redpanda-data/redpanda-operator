...
func (in *ShadowTopicStatus) DeepCopyInto(out *ShadowTopicStatus) {
	*out = *in
	in.LastTransitionTime.DeepCopyInto(&out.LastTransitionTime)
	if in.PartitionInformation != nil {
		in, out := &in.PartitionInformation, &out.PartitionInformation
		*out = make([]TopicPartitionInformation, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TopicPartitionInformation) DeepCopyInto(out *TopicPartitionInformation) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TopicPartitionInformation.
func (in *TopicPartitionInformation) DeepCopy() *TopicPartitionInformation {
	if in == nil {
		return nil
	}
	out := new(TopicPartitionInformation)
	in.DeepCopyInto(out)
	return out
}
