...
func (in *BrokerTemplate) DeepCopyInto(out *BrokerTemplate) {
	*out = *in
	...
	if in.RPKConfig != nil {
		in, out := &in.RPKConfig, &out.RPKConfig
		*out = make(map[string]ValueSource, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CertManagerCertificateSource) DeepCopyInto(out *CertManagerCertificateSource) {
	*out = *in
	if in.Duration != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CertManagerCertificateSource.
func (in *CertManagerCertificateSource) DeepCopy() *CertManagerCertificateSource {
	if in == nil {
		return nil
	}
	out := new(CertManagerCertificateSource)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CertificateSource) DeepCopyInto(out *CertificateSource) {
	*out = *in
	if in.IssuerRef != nil {
		...
		*out = new(IssuerRefCertificateSource)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IssuerRefCertificateSource) DeepCopyInto(out *IssuerRefCertificateSource) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IssuerRefCertificateSource.
func (in *IssuerRefCertificateSource) DeepCopy() *IssuerRefCertificateSource {
	if in == nil {
		return nil
	}
	out := new(IssuerRefCertificateSource)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RPCListener) DeepCopyInto(out *RPCListener) {
	*out = *in
	if in.TLS != nil {
		in, out := &in.TLS, &out.TLS
		*out = new(ListenerTLS)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RPCListener.
func (in *RPCListener) DeepCopy() *RPCListener {
	if in == nil {
		return nil
	}
	out := new(RPCListener)
