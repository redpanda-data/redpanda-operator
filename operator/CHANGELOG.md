...
* Add rpk profile to default home location in official Redpanda container. With that change any command in rpk that reaches Kafka, Admin API or Schema registry listener should just work.
### Changed
