...
require (
	...
	github.com/redpanda-data/redpanda-operator/operator v0.0.0-20250417174137-234f93a35ce2
...
require (
	...
	github.com/redpanda-data/common-go/rpadmin v0.1.13-0.20250109154132-12ac78a58f95 // indirect
