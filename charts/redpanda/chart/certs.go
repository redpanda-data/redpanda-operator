...
// PKI resolves this chart's values into the shared certificate set, which
// never sees chart values. It is the chart's one translation function for
// everything certificate shaped: volumes, mounts, and issuance.
