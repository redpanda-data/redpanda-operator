...
{{- $_932_uid_gid := (get (fromJson (include "redpanda.securityContextUidGid" (dict "a" (list $state $pool "sidecar")))) "r") -}}
{{- $uid := ((index $_932_uid_gid 0) | int64) -}}
{{- $gid := ((index $_932_uid_gid 1) | int64) -}}
{{- $_is_returning = true -}}
