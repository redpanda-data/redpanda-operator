...
{{- $minReplicas := ((div ($state.Values.statefulset.replicas | int) (2 | int)) | int) -}}
...
{{- $matchLabels := (get (fromJson (include "redpanda.StatefulSetPodLabelsSelector" (dict "a" (list $state)))) "r") -}}
