...
{{- end -}}
{{- $adminSpec := (coalesce nil) -}}
{{- if $state.Values.listeners.admin.enabled -}}
...
{{- $_104_adminAuthEnabled__ := (get (fromJson (include "_shims.typetest" (dict "a" (list "bool" (index $state.Values.config.cluster "admin_api_require_auth") false)))) "r") -}}
{{- $adminAuthEnabled := (index $_104_adminAuthEnabled__ 0) -}}
{{- $_ := (index $_104_adminAuthEnabled__ 1) -}}
{{- if $adminAuthEnabled -}}
