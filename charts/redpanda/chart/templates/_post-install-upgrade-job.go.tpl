...
{{- $_37_____additionalEnv := (get (fromJson (include "redpanda.ClusterConfiguration.Translate" (dict "a" (list (deepCopy $state.Values.config.extraClusterConfiguration))))) "r") -}}
{{- $_ := (index $_37_____additionalEnv 0) -}}
{{- $_ := (index $_37_____additionalEnv 1) -}}
{{- $additionalEnv := (index $_37_____additionalEnv 2) -}}
{{- $_is_returning = true -}}
