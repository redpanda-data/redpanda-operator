...
{{- $_75_namespace_ok := (get (fromJson (include "_shims.lookup" (dict "a" (list "v1" "Namespace" "" "kube-system")))) "r") -}}
{{- $namespace := (index $_75_namespace_ok 0) -}}
{{- $ok := (index $_75_namespace_ok 1) -}}
{{- if $ok -}}
