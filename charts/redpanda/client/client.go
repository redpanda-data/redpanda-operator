...
// unpublishes.
func SchemaRegistryClientForHosts(state *redpanda.RenderState, dialer DialContextFunc, hosts []string, opts ...sr.ClientOpt) (*sr.Client, error) {
...
// timeout.
func schemaRegistryClient(state *redpanda.RenderState, dialer DialContextFunc, resolveHosts func() ([]string, error), opts ...sr.ClientOpt) (*sr.Client, error) {
	prefix := "http://"
