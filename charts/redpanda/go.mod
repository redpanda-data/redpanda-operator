...
require (
	...
	github.com/redpanda-data/redpanda-operator/gotohelm v1.0.0
...
require (
	...
	github.com/redpanda-data/redpanda-operator/operator v0.0.0-20250416175220-c6f8d18c5557 // indirect
