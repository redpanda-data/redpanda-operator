...
func Roles(dot *helmette.Dot) []*rbacv1.Role {
	...
	mapping := map[string]bool{
		"files/sidecar.Role.yaml":          values.RBAC.Enabled,
		"files/pvcunbinder.Role.yaml":      values.RBAC.Enabled && values.Statefulset.SideCars.PVCUnbinder.Enabled,
		"files/decommission.Role.yaml":     values.RBAC.Enabled && values.Statefulset.SideCars.BrokerDecommissioner.Enabled,
...
func ClusterRoles(dot *helmette.Dot) []*rbacv1.ClusterRole {
	...
	mapping := map[string]bool{
		"files/pvcunbinder.ClusterRole.yaml":    values.RBAC.Enabled && values.Statefulset.SideCars.PVCUnbinder.Enabled,
		"files/decommission.ClusterRole.yaml":   values.RBAC.Enabled && values.Statefulset.SideCars.BrokerDecommissioner.Enabled,
