...
{{- break -}}
{{- end -}}
{{- $_524_uid_gid := (get (fromJson (include "redpanda.securityContextUidGid" (dict "a" (list $dot "set-tiered-storage-cache-dir-ownership") ))) "r") -}}
{{- $uid := ((index $_524_uid_gid 0) | int64) -}}
{{- $gid := ((index $_524_uid_gid 1) | int64) -}}
