...
{{- $_205_existing_4_ok_5 := (get (fromJson (include "_shims.lookup" (dict "a" (list "v1" "Secret" $dot.Release.Namespace $secretName) ))) "r") -}}
{{- $existing_4 := (index $_205_existing_4_ok_5 0) -}}
{{- $ok_5 := (index $_205_existing_4_ok_5 1) -}}
{{- if $ok_5 -}}
{{- $_is_returning = true -}}
