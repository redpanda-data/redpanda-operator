...
{{- $_208_existing_5_ok_6 := (get (fromJson (include "_shims.lookup" (dict "a" (list "v1" "Secret" $dot.Release.Namespace $secretName) ))) "r") -}}
{{- $existing_5 := (index $_208_existing_5_ok_6 0) -}}
{{- $ok_6 := (index $_208_existing_5_ok_6 1) -}}
{{- if $ok_6 -}}
{{- $_is_returning = true -}}
