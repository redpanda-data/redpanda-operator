...
// InitContainerRenderer renders core init containers for a redpanda
// deployment.
type InitContainerRenderer struct {
	...
	// host-tuner or bootstrap containers.
...
// TuningInitContainer configures the init container that runs `rpk redpanda
// tune all`.
type TuningInitContainer struct {
	// OnHost selects the chroot-into-/host variant that can reach the node's real
	// block devices and sysctls; see [HostTunerScript()].
	OnHost bool
}
...
// TODO: this should be combined into [DataDirOwnershipInitContainer].
...
func (r *InitContainerRenderer) Render() []corev1.Container {
...
// mounts returns CommonMounts as a fresh slice.
func (r *InitContainerRenderer) mounts() []corev1.VolumeMount {
	var mounts []corev1.VolumeMount
	mounts = append(mounts, r.CommonMounts...)
	return mounts
}

func (r *InitContainerRenderer) setDataDirOwnershipContainer(opts *DataDirOwnershipInitContainer) corev1.Container {
...
func (r *InitContainerRenderer) fsValidatorContainer(opts *FSValidatorInitContainer) corev1.Container {
	return corev1.Container{
...
func (r *InitContainerRenderer) configuratorContainer(opts *ConfiguratorInitContainer) corev1.Container {
	volMounts := append(
		r.mounts(),
		corev1.VolumeMount{
...
func (r *InitContainerRenderer) setTieredStorageCacheDirOwnershipContainer(opts *TieredStorageCacheOwnershipInitContainer) corev1.Container {
	volMounts := append(
		r.mounts(),
		corev1.VolumeMount{
			Name:      DatadirVolumeName,
...
func (r *InitContainerRenderer) bootstrapYamlTemplaterContainer(opts *BootstrapInitContainer) corev1.Container {
	return corev1.Container{
...
func (r *InitContainerRenderer) tuningContainer() corev1.Container {
	return corev1.Container{
...
func (r *InitContainerRenderer) tuningOnHostContainer() corev1.Container {
	return corev1.Container{
		Name:    RedpandaTuningContainerName,
		Image:   r.Image,
