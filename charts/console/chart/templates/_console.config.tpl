...
{{- break -}}
{{- end -}}
{{- $_242___ok_12 := (get (fromJson (include "_shims.dicttest" (dict "a" (list $v.ConfigMaps $ref.name (coalesce nil))))) "r") -}}
{{- $_ := (index $_242___ok_12 0) -}}
{{- $ok_12 := (index $_242___ok_12 1) -}}
{{- if (not $ok_12) -}}
...
{{- break -}}
{{- end -}}
{{- $_258___ok_13 := (get (fromJson (include "_shims.dicttest" (dict "a" (list $v.Secrets $ref.name (coalesce nil))))) "r") -}}
{{- $_ := (index $_258___ok_13 0) -}}
{{- $ok_13 := (index $_258___ok_13 1) -}}
{{- if (not $ok_13) -}}
