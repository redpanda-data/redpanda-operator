...
{{- $_36_asInt_1_ok_2 := (get (fromJson (include "_shims.asintegral" (dict "a" (list $configListenPort) ))) "r") -}}
{{- $asInt_1 := ((index $_36_asInt_1_ok_2 0) | int) -}}
{{- $ok_2 := (index $_36_asInt_1_ok_2 1) -}}
{{- if $ok_2 -}}
{{- $_is_returning = true -}}
