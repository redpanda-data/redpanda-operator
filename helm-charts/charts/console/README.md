...
This page describes the official Redpanda Console Helm Chart. In particular, this page describes the contents of the chart’s [`values.yaml` file](https://github.com/redpanda-data/redpanda-operator/helm-charts/blob/main/charts/console/values.yaml).
...
* <https://github.com/redpanda-data/redpanda-operator/helm-charts>
