...
| golang.org/x/term | [BSD-3-Clause](https://cs.opensource.google/go/x/term/+/v0.39.0:LICENSE) |
...
| k8s.io/api | [Apache-2.0](https://github.com/kubernetes/api/blob/v0.33.8/LICENSE) |
| k8s.io/apiextensions-apiserver/pkg | [Apache-2.0](https://github.com/kubernetes/apiextensions-apiserver/blob/v0.33.3/LICENSE) |
| k8s.io/apimachinery/pkg | [Apache-2.0](https://github.com/kubernetes/apimachinery/blob/v0.33.8/LICENSE) |
| k8s.io/apimachinery/third_party/forked/golang | [BSD-3-Clause](https://github.com/kubernetes/apimachinery/blob/v0.33.8/third_party/forked/golang/LICENSE) |
...
| k8s.io/client-go | [Apache-2.0](https://github.com/kubernetes/client-go/blob/v0.33.8/LICENSE) |
| k8s.io/client-go/third_party/forked/golang/template | [BSD-3-Clause](https://github.com/kubernetes/client-go/blob/v0.33.8/third_party/forked/golang/LICENSE) |
