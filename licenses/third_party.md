...
| github.com/klauspost/compress | [MIT](https://github.com/klauspost/compress/blob/v1.17.11/LICENSE) |
| github.com/klauspost/compress | [Apache-2.0](https://github.com/klauspost/compress/blob/v1.17.11/LICENSE) |
| github.com/klauspost/compress | [BSD-3-Clause](https://github.com/klauspost/compress/blob/v1.17.11/LICENSE) |
...
| github.com/prometheus/common | [Apache-2.0](https://github.com/prometheus/common/blob/v0.62.0/LICENSE) |
...
| go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp | [Apache-2.0](https://github.com/open-telemetry/opentelemetry-go-contrib/blob/instrumentation/net/http/otelhttp/v0.57.0/instrumentation/net/http/otelhttp/LICENSE) |
