...
| cloud.google.com/go/auth | [Apache-2.0](https://github.com/googleapis/google-cloud-go/blob/auth/v0.18.1/LICENSE) |
...
| github.com/fluxcd/pkg/runtime/logger | [Apache-2.0](https://github.com/fluxcd/pkg/blob/runtime/v0.43.3/LICENSE) |
...
| github.com/go-openapi/swag/cmdutils | [Apache-2.0](https://github.com/go-openapi/swag/blob/cmdutils/v0.25.4/LICENSE) |
| github.com/go-openapi/swag/conv | [Apache-2.0](https://github.com/go-openapi/swag/blob/conv/v0.25.4/LICENSE) |
| github.com/go-openapi/swag/fileutils | [Apache-2.0](https://github.com/go-openapi/swag/blob/fileutils/v0.25.4/LICENSE) |
| github.com/go-openapi/swag/jsonname | [Apache-2.0](https://github.com/go-openapi/swag/blob/jsonname/v0.25.4/LICENSE) |
| github.com/go-openapi/swag/jsonutils | [Apache-2.0](https://github.com/go-openapi/swag/blob/jsonutils/v0.25.4/LICENSE) |
| github.com/go-openapi/swag/loading | [Apache-2.0](https://github.com/go-openapi/swag/blob/loading/v0.25.4/LICENSE) |
| github.com/go-openapi/swag/mangling | [Apache-2.0](https://github.com/go-openapi/swag/blob/mangling/v0.25.4/LICENSE) |
| github.com/go-openapi/swag/netutils | [Apache-2.0](https://github.com/go-openapi/swag/blob/netutils/v0.25.4/LICENSE) |
...
| github.com/knadh/koanf/maps | [MIT](https://github.com/knadh/koanf/blob/maps/v0.1.2/LICENSE) |
| github.com/knadh/koanf/parsers/yaml | [MIT](https://github.com/knadh/koanf/blob/parsers/yaml/v1.1.0/LICENSE) |
| github.com/knadh/koanf/providers/confmap | [MIT](https://github.com/knadh/koanf/blob/providers/confmap/v1.0.0/LICENSE) |
| github.com/knadh/koanf/providers/env | [MIT](https://github.com/knadh/koanf/blob/providers/env/v1.1.0/LICENSE) |
| github.com/knadh/koanf/providers/file | [MIT](https://github.com/knadh/koanf/blob/providers/file/v1.2.0/LICENSE) |
...
| github.com/moby/sys/mountinfo | [Apache-2.0](https://github.com/moby/sys/blob/mountinfo/v0.7.2/LICENSE) |
...
| github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring | [Apache-2.0](https://github.com/prometheus-operator/prometheus-operator/blob/pkg/apis/monitoring/v0.89.0/LICENSE) |
...
| github.com/quasilyte/go-ruleguard/dsl | [BSD-3-Clause](https://github.com/quasilyte/go-ruleguard/blob/dsl/v0.3.22/LICENSE) |
...
| github.com/twmb/franz-go/pkg/kadm | [BSD-3-Clause](https://github.com/twmb/franz-go/blob/pkg/kadm/v1.17.2/LICENSE) |
| github.com/twmb/franz-go/pkg/kmsg | [BSD-3-Clause](https://github.com/twmb/franz-go/blob/pkg/kmsg/v1.12.0/LICENSE) |
| github.com/twmb/franz-go/pkg/sasl/kerberos | [BSD-3-Clause](https://github.com/twmb/franz-go/blob/pkg/sasl/kerberos/v1.1.0/LICENSE) |
| github.com/twmb/franz-go/pkg/sr | [BSD-3-Clause](https://github.com/twmb/franz-go/blob/pkg/sr/v1.7.0/LICENSE) |
...
| go.etcd.io/etcd/client/v3 | [Apache-2.0](https://github.com/etcd-io/etcd/blob/client/v3.6.8/client/v3/LICENSE) |
...
| go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc | [Apache-2.0](https://github.com/open-telemetry/opentelemetry-go-contrib/blob/instrumentation/google.golang.org/grpc/otelgrpc/v0.65.0/LICENSE) |
| go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc | [BSD-3-Clause](https://github.com/open-telemetry/opentelemetry-go-contrib/blob/instrumentation/google.golang.org/grpc/otelgrpc/v0.65.0/LICENSE) |
| go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp | [Apache-2.0](https://github.com/open-telemetry/opentelemetry-go-contrib/blob/instrumentation/net/http/otelhttp/v0.65.0/LICENSE) |
...
| go.opentelemetry.io/otel/metric | [Apache-2.0](https://github.com/open-telemetry/opentelemetry-go/blob/metric/v1.43.0/LICENSE) |
| go.opentelemetry.io/otel/metric | [BSD-3-Clause](https://github.com/open-telemetry/opentelemetry-go/blob/metric/v1.43.0/LICENSE) |
...
| go.opentelemetry.io/otel/trace | [Apache-2.0](https://github.com/open-telemetry/opentelemetry-go/blob/trace/v1.43.0/LICENSE) |
| go.opentelemetry.io/otel/trace | [BSD-3-Clause](https://github.com/open-telemetry/opentelemetry-go/blob/trace/v1.43.0/LICENSE) |
| go.opentelemetry.io/proto/otlp | [Apache-2.0](https://github.com/open-telemetry/opentelemetry-proto-go/blob/otlp/v1.10.0/LICENSE) |
...
| golang.org/x/crypto | [BSD-3-Clause](https://go.googlesource.com/crypto/+/v0.49.0/LICENSE) |
| golang.org/x/exp | [BSD-3-Clause](https://go.googlesource.com/exp/+/3dfff04db8fa/LICENSE) |
| golang.org/x/mod/semver | [BSD-3-Clause](https://go.googlesource.com/mod/+/v0.33.0/LICENSE) |
| golang.org/x/net | [BSD-3-Clause](https://go.googlesource.com/net/+/v0.52.0/LICENSE) |
| golang.org/x/oauth2 | [BSD-3-Clause](https://go.googlesource.com/oauth2/+/v0.35.0/LICENSE) |
| golang.org/x/sync | [BSD-3-Clause](https://go.googlesource.com/sync/+/v0.20.0/LICENSE) |
| golang.org/x/sys | [BSD-3-Clause](https://go.googlesource.com/sys/+/v0.42.0/LICENSE) |
| golang.org/x/term | [BSD-3-Clause](https://go.googlesource.com/term/+/v0.41.0/LICENSE) |
| golang.org/x/text | [BSD-3-Clause](https://go.googlesource.com/text/+/v0.35.0/LICENSE) |
| golang.org/x/time/rate | [BSD-3-Clause](https://go.googlesource.com/time/+/v0.14.0/LICENSE) |
| golang.org/x/tools | [BSD-3-Clause](https://go.googlesource.com/tools/+/v0.42.0/LICENSE) |
...
| google.golang.org/genproto/googleapis/api | [Apache-2.0](https://github.com/googleapis/go-genproto/blob/9d38bb4040a9/LICENSE) |
| google.golang.org/genproto/googleapis/rpc | [Apache-2.0](https://github.com/googleapis/go-genproto/blob/9d38bb4040a9/LICENSE) |
...
| k8s.io/kube-openapi/pkg/internal/third_party/go-json-experiment/json | [BSD-3-Clause](https://github.com/kubernetes/kube-openapi/blob/a19766b6e2d4/pkg/internal/third_party/go-json-experiment/json/LICENSE) |
...
| sigs.k8s.io/kustomize/kyaml | [Apache-2.0](https://github.com/kubernetes-sigs/kustomize/blob/kyaml/v0.20.1/LICENSE) |
