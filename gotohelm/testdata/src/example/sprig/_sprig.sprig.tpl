...
{{- $zero := (0 | int) -}}
{{- $_is_returning = true -}}
{{- (dict "r" (list (default "fallback" $empty) (default "fallback" "set") (default (default "third" $empty) $empty) (default (default "third" "second") "first") (default (1234 | int) $zero) (default (1234 | int) (5678 | int)) (default $empty $empty))) | toJson -}}
{{- break -}}
{{- end -}}
{{- end -}}
